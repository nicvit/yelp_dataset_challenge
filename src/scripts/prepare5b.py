...
for it in iter:
	...
	if a1[1] < 0.05:
		itavg = round(np.mean(sentiment[it:(it+20)]),3)
		itadd = [it, itavg]
...
[[309, -0.225], [310, -0.147], [311, -0.24], [312, -0.243], [719, 0.307], [720, 0.395], [721, 0.292], [723, 0.393], [724, 0.447], [725, 0.422], [726, 0.402], [727, 0.483], [728, 0.424], [729, 0.433], [730, 0.421], [731, 0.383], [732, 0.342], [733, 0.223], [734, 0.189], [735, 0.213], [736, 0.231], [737, 0.226]]
